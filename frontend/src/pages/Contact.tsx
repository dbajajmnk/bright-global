    ...
    <section className="px-6 md:px-20 py-10 space-y-12">
      ...
      <div>
        ...
        <div className="space-y-2 text-lg text-textPrimary">
          ...
          <p><strong>Website:</strong> <a href="https://www.techlambda.com" target="_blank" rel="noopener noreferrer" className="text-primary underline">www.techlambda.com</a></p>
        </div>

        {/* Social Links */}
        <div className="mt-6">
          <h3 className="text-xl font-semibold text-secondary mb-2">Connect with us</h3>
          <div className="flex flex-wrap gap-4 text-primary text-lg">
            <a href="https://whatsapp.com/channel/0029VarZn9aGk1FnlCttz11q" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 hover:underline">
              <FaWhatsapp /> WhatsApp Channel
            </a>
            <a href="https://www.youtube.com/@techlambda360" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 hover:underline">
              <FaYoutube /> YouTube
            </a>
            <a href="https://www.linkedin.com/company/105116331/admin/dashboard/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 hover:underline">
              <FaLinkedin /> LinkedIn
            </a>
            <a href="https://www.facebook.com/profile.php?id=61566939595712" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 hover:underline">
              <FaFacebook /> Facebook
            </a>
            <a href="https://www.instagram.com/techlambdaservices/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 hover:underline">
